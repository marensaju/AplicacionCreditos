        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
              ...
              if (RadioButton1.Checked == true)
                ...
                //cliente;
                per.Cliente(f_registro, true, lugartrabajo, dirtrabajo, telefonotrabajo, tiempolaborar, observacion, false, id,false);
                //referencia
                ...
                bita.RegistrarBitacora("Registro", "Creacion de cliente"+ Convert.ToString(id), Convert.ToInt32(Session["idempleado"]));
