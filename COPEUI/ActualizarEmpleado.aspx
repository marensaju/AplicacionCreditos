<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="ActualizarEmpleado.aspx.cs" Inherits="COPEUI.ActualizarEmpleado" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script runat="server">
      ...
      void Check_Clicked3(Object sender, EventArgs e) 
      {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="snackbar">Empleado Actualizado exitosamente :) </div>
     ...
     <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                            ...
                            <div class="form-horizontal"> 
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Correo Electronico*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                            <asp:TextBox ID="TextCorreo" placeholder="Correo Electronico" type="email" CssClass="form-control required" runat="server"></asp:TextBox>
                                       </div>
                                             </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Fecha de nacimiento*</label>
                                    ...
                                    <asp:TextBox ID="TextNacimiento" required="" CssClass="form-control" value="01/01/2017" runat="server"></asp:TextBox>  
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Número de teléfono *</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                             ...
                                             <div class="col-md-12">
                                                 <asp:TextBox ID="TextTelefonoPersonal"  CssClass="form-control required" data-mask="9999-9999" placeholder="5285-5355" runat="server"></asp:TextBox>
                                             </div>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Teléfono residencial*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextTelefonoResidencial"  CssClass="form-control required" data-mask="9999-9999" placeholder="7930-4424" runat="server"></asp:TextBox>
                                            </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Fotografia*</label>
                                    <div class="col-sm-9">
                                    <div class="col-md-12">
                                        <asp:Image ID="Image1" heigth="100" Width="100"  runat="server" />  
                                    </div>
                                        </div>
                                    
                                </div>
                                <div class="form-group"> <label class="col-sm-2 control-label">Cambiar Fotografia</label>
                                    <div class="col-sm-9">
                                    <div class="col-md-12">
                                                 
                                                <asp:CheckBox ID="CheckBox1"  runat="server" OnCheckedChanged="Check_Clicked" AutoPostBack="True" />
                ...
                <div class="col-lg-5">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Contratación <small>Verifique todos los campos antes de finalizar.</small></h5>
                            <div class="ibox-tools">
                                <a class="collapse-link">
                                    <i class="fa fa-chevron-up"></i>
                                </a>
                  ...
                  <div  class="form-horizontal">
                      ...
                      -->
                            ...
                            <p>
                                Datos relacionados con la contratación del empleado.
                            </p>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Fecha*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextTrabajo" placeholder="Fecha Contratación" CssClass="form-control required" data-mask="99/99/9999" runat="server"></asp:TextBox>
                                            </div>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Salario*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextSalario" placeholder="2578,78" CssClass="form-control required" runat="server"></asp:TextBox>
                                            </div>
                                ...
                                <div class="hr-line-dashed"></div>
                               <div class="form-group"><label class="col-sm-2 control-label">% de comisión*</label>

                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextPorcentaje" CssClass="form-control"  data-mask="99" value="10" runat="server"></asp:TextBox>
                                            </div>
                                ...
                                <div class="hr-line-dashed"></div>
                               <div class="form-group"><label class="col-sm-2 control-label">Cantidad por comisión*</label>

                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextCantidadPorComision" placeholder="1250,45" CssClass="form-control required" runat="server"></asp:TextBox>
                                            </div>
                           ...
                           <div class="hr-line-dashed"></div>
                      <div class="form-group"><label class="col-sm-2 control-label">Agencia*</label>

                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextAgencia" CssClass="form-control required" runat="server"></asp:TextBox>
                                            </div>
                      ...
                      <div class="form-group"><label class="col-sm-2 control-label">Cambiar Agencia*</label>

                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:CheckBox ID="CheckBox2"  runat="server" OnCheckedChanged="Check_Clicked2" AutoPostBack="True" />
                                                <asp:DropDownList ID="DropDownList1"  CssClass="chosen-select" runat="server" AutoPostBack="False" Visible="False"></asp:DropDownList>
                                            </div>
                      ...
                      <div class="form-group"><label class="col-sm-2 control-label">Puesto*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:Label ID="LabePuesato" runat="server" Visible="false" Text=""></asp:Label>
                                                <asp:TextBox ID="TextPuesto"  CssClass="form-control required" runat="server"></asp:TextBox>
                                            </div>
                      ...
                      <div class="hr-line-dashed"></div>
                      <div class="form-group"><label class="col-sm-2 control-label"> Cambiar Puesto*</label>

                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:CheckBox ID="CheckBox3"  runat="server" OnCheckedChanged="Check_Clicked3" AutoPostBack="True" />
                                                 <asp:DropDownList ID="DropDownList2" CssClass="chosen-select" runat="server" Visible="False"></asp:DropDownList>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="TextRef3" required="" placeholder="Teléfono"  CssClass="form-control " runat="server"></asp:TextBox>
                                                 <asp:Label ID="LaRef1" Visible="false" runat="server" Text="Label"></asp:Label>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="TextRef6" placeholder="Teléfono"  CssClass="form-control " runat="server"></asp:TextBox>
                                                 <asp:Label ID="LaRef2" Visible="false" runat="server" Text="Label"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <asp:TextBox ID="TextRef9" placeholder="Teléfono"  CssClass="form-control " runat="server"></asp:TextBox>
                                                 <asp:Label ID="LaRef3" Visible="false" runat="server" Text="Label"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
