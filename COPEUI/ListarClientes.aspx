<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="ListarClientes.aspx.cs" Inherits="COPEUI.ListarClientes" %>
         ...
         <div class="col-sm-7">
             ...
             <div class="m-b-md" style="line-height: 0px;">
              ...
              <div class="m-b-md text-right" style="line-height: -20px;">
                              ...
                              <asp:Button ID="Button3"  CssClass="btn btn-xs btn-white" runat="server" Text="Enviar a lista negra" OnClick="Button3_Click" />
                                    ...
                                    <div class="full-height-scroll">
                                        ...
                                        <div class="col-lg-8">
                                            <asp:Button ID="Button5"   CssClass="btn btn-success"  runat="server" Text="Imprimir" OnClick="Button5_Click" />
                                              <asp:Button ID="Button6"   CssClass="btn btn-warning"  runat="server" Text="Permitir préstamo" OnClick="Button6_Click"  />
                                             <h4>
