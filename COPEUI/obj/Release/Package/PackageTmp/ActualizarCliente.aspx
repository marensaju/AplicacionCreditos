<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="ActualizarCliente.aspx.cs" Inherits="COPEUI.ActualizarCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="snackbar">Datos actualizados exitosamente :) </div>
                            ...
                            <p>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Donde trabaja*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextTrabajo" placeholder="Empresa o lugar de trabajo " CssClass="form-control required" runat="server"></asp:TextBox>
                                            </div>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Dirección*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextDirTrabajo" placeholder="Dirección del trabajo " CssClass="form-control required" runat="server"></asp:TextBox>
                                            </div>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Teléfono*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextTelefonoTra" CssClass="form-control required" data-mask="9999-9999" placeholder="7930-4425" runat="server"></asp:TextBox>
                                            </div>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Tiempo*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextTiempoTra" placeholder="Tiempo de trabajar en empresa o negocio"  CssClass="form-control required" runat="server"></asp:TextBox>
                                            </div>
