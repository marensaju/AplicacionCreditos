<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="VerEmpleados.aspx.cs" Inherits="COPEUI.VerEmpleados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="snackbar">Cliente Enviado a lista negra </div>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <div class="wrapper wrapper-content  animated fadeInRight">
            ...
            <Columns>
                <asp:ImageField  ControlStyle-CssClass="client-avatar"  DataImageUrlField="Ruta_Fotografia" DataImageUrlFormatString="~/ImagenesCargadas/Empleados/{0}" HeaderText="Imagen">
                </asp:ImageField>
         ...
         <div class="col-sm-7">
             ...
             <div class="m-b-md" style="line-height: 0px;">
                            <h2 class="font-bold no-margins">
                                <asp:Label ID="Label1" CssClass="text-white text-right text-xs bloc" runat="server" Text="Nombre de cliente"></asp:Label>
              ...
              <div class="m-b-md text-right" style="line-height: -20px;">
                              ...
                              <asp:Button ID="Button3"  CssClass="btn btn-xs btn-white" runat="server" Text="Dar de baja" OnClick="Button3_Click" />
                                 <asp:Button ID="Button6"  CssClass="btn btn-xs btn-success" runat="server" Text="Usuario" OnClick="Button6_Click" />
                                    ...
                                    <div class="full-height-scroll">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <p>                                
                                           <strong><i class="fa fa-puzzle-piece"></i> DPI:</strong> <asp:Label ID="Label3" runat="server" Text="1234-56789-0901"></asp:Label> 
                                            </p>
                                            <p>
                                             <strong><i class="fa fa-map-marker"></i> Dirección:</strong> <asp:Label ID="Label4" runat="server" Text="Dirección de domicilio"></asp:Label>
                                         </p>
                                            <p>
                                            ...
                                            <p>
                                             <strong><i class="fa fa-suitcase"></i> Fecha contratación:</strong> <asp:Label ID="Label6" runat="server" Text="1/1/17"></asp:Label>
                                             </p>
                                            <p>
                                             <strong><i class="fa fa-map-marker"></i> Puesto:</strong> <asp:Label ID="Label7" runat="server" Text="Puesto"></asp:Label> 
                                         </p>
                                            <p>
                                              <strong><i class="fa fa-map-marker"></i> Sueldo:</strong> <asp:Label ID="Label9" runat="server" Text="Q0.000"></asp:Label>
                                             </p>
                                         
                                            <p>
                                             <strong><i class="fa fa-map-marker"></i> Cant. Comision:</strong> <asp:Label ID="Label10" runat="server" Text="Q0.000"></asp:Label> 
                                         </p>
                                            
                                            <p>
                                             <strong><i class="fa fa-map-marker"></i> Porcentaje  :</strong> <asp:Label ID="Label11" runat="server" Text="0"></asp:Label> 
                                         </p>
                                            <p>
                                             <strong><i class="fa fa-map-marker"></i>fech. Nacimiento:</strong> <asp:Label ID="Label12" runat="server" Text="1/1/17"></asp:Label> 
                                         </p>


                                            
                                        <p>
                                             <strong></i>Referencias</strong> 
                                         </p>
