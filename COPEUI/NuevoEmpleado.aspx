<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="NuevoEmpleado.aspx.cs" Inherits="COPEUI.NuevoEmpleado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div id="snackbar">Empleado Registrado exitosamente :) </div>
                            ...
                            <div class="form-horizontal"> 
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Correo Electronico*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                            <asp:TextBox ID="TextCorreo" placeholder="Correo Electronico" type="email" CssClass="form-control required" required=""  runat="server"></asp:TextBox>
                                       </div>
                                             </div>
                                    </div>
                                </div>
                  ...
                  <div  class="form-horizontal">
                            ...
                            <p>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Fecha*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextTrabajo" required="" placeholder="Fecha Contratación" CssClass="form-control required" data-mask="99/99/9999" runat="server"></asp:TextBox>
                                            </div>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Salario*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextSalario" required="" placeholder="2578,78" CssClass="form-control required" runat="server"></asp:TextBox>
                                            </div>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">% de comisión*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextPorcentaje" required="" CssClass="form-control"  data-mask="99" value="10" runat="server"></asp:TextBox>
                                            </div>
                               ...
                               <div class="form-group"><label class="col-sm-2 control-label">Cantidad por comisión*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:TextBox ID="TextCantidadPorComision" required="" placeholder="1250,45" CssClass="form-control required" runat="server"></asp:TextBox>
                                            </div>
                      ...
                      <div class="form-group"><label class="col-sm-2 control-label">Puesto*</label>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-12">
                                                 <asp:DropDownList ID="DropDownList2" CssClass="chosen-select" runat="server"></asp:DropDownList>
                                            </div>
