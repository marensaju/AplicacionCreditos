<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="Balance.aspx.cs" Inherits="COPEUI.Balance" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SaldoCartera" HeaderText="Saldo cartera"  />         
            </Columns>
        </asp:GridView>
